...
//    self.leftImageView.center = self.scrollView.center;
    self.centerImageView.frame = CGRectMake(imageW*1, 0, imageW, imageH);
//    self.centerImageView.center = self.scrollView.center;
    self.rightImageView.frame  = CGRectMake(imageW*2, 0, imageW, imageH);
//    self.rightImageView.center = self.scrollView.center;
...
//    CGPoint point = self.scrollView.center;
//    
//    _leftImageView.center   = point;
//    _centerImageView.center = point;
//    _rightImageView.center  = point;
    
//    UIBezierPath *maskPathLeft = [UIBezierPath bezierPathWithRoundedRect:self.leftImageView.bounds byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(10, 10)];
//    UIBezierPath *maskPathCenter = [UIBezierPath bezierPathWithRoundedRect:self.centerImageView.bounds byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(10, 10)];
//    UIBezierPath *maskPathRight = [UIBezierPath bezierPathWithRoundedRect:self.rightImageView.bounds byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(10, 10)];
//    
//    CAShapeLayer *maskLayer = [[CAShapeLayer alloc] init];
//    maskLayer.frame = self.leftImageView.bounds;
//    maskLayer.path = maskPathLeft.CGPath;
//    self.leftImageView.layer.mask = maskLayer;
//    
//    maskLayer.frame = self.centerImageView.bounds;
//    maskLayer.path = maskPathCenter.CGPath;
//    self.centerImageView.layer.mask = maskLayer;
//
//    maskLayer.frame = self.rightImageView.bounds;
//    maskLayer.path = maskPathRight.CGPath;
//    self.rightImageView.layer.mask = maskLayer;
